"""
Django settings for chocolate_factory project.
...
SECRET_KEY = 'django-insecure-ku9xawdf%_f$cst8!x=$o%$6m3+yez-g$e8-reobo8_!qg49u+'
...
ROOT_URLCONF = 'chocolate_factory.urls'
...
# Stores messages in the session for gitpod, not essential
...
WSGI_APPLICATION = 'chocolate_factory.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'dummyemail@example.com'